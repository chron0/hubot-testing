...
#   If updates are downloaded you'll need to restart hubot, for
#   example using "hubot die" (restart using a watcher like forever.js).
#
# Dependencies:
#   None
#
...
#   hubot pending update - Informs if there are pending updates
#
# Author:
#   benjamine
...
module.exports = (robot) ->
  ...
  robot.respond /pending updates?\??$/i, (msg) ->
    if downloaded_updates
      msg.send "Goodbye, cruel world... until monit respawns me."
      process.exit 0
    else
