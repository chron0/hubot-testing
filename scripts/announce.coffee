...
module.exports = (robot) ->
  ...
  robot.respond /announce "(.*)"/i, (msg) ->
    ...
    for room in allRooms
      robot.logger.info('announce', room, announcement)
  ...
  robot.respond /announce downtime for "(.*)" starting (.*)/i, (msg) ->
    ...
    message = ["'#{service}' will be going down for maintenance starting #{startTime}.",
      "If you have questions about this maintenance, please talk to #{user.name} in the #{user.room} room."]
  ...
  robot.respond /announce downtime complete for "(.*)"/i, (msg) ->
    ...
    for room in allRooms
      robot.messageRoom room,
          "Maintenance of '#{service}' is completed. Thank you for your patience."
